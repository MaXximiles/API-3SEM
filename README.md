...
- Exclusão de diretórios e subdiretórios quando manual e/ou bloco é excluido
...
- Criação da LEP automatica, gravando no arquivo pdf modelolep 
...
Para a proxíma entrega nosso grupo pretende aperfeiçoar e finalizar as funcionalidades desejadas pelo cliente, além de, dentro do possível implementar funcionalidades extras ao projeto.
