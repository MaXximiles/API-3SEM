...
const Modal = ({ title, isOpen, setOpen, fadeDuration = 500, children }) => {
  ...
  return ReactDOM.createPortal(
    <div className={`ui dimmer modals page transition ${modalAnimation}`} style={{animationDuration:fadeTimer}}>
      <div ref={ref} className={`ui standard modal transition ${modalContentAnimation}`} style={{animationDuration:fadeTimer}}>
