...
public class RelacaoBlocoTracoController {
  ...
  public void insertRelacaoBlocoTraco(@RequestBody RelacaoBlocoTracoRq relBlocoTraco) {
    if (relBlocoTraco.getBlocoid() != "" && relBlocoTraco.getTracoid() != "") {
  ...
  // DELETE
  @PostMapping("/delete")
  public void deleteRelacaoCodelistTraco(@RequestBody RelacaoBlocoTracoRq relBlocoTraco) {
    if (relBlocoTraco.getBlocoid() != "" && relBlocoTraco.getTracoid() != "") {
      relacaoBlocoTracoRepository.DeleteTracosDoc(Long.valueOf(relBlocoTraco.getBlocoid()),
